...
public:
	...
	virtual int PosMode(u8 ID);//位置模式
	...
	virtual int isOverload(u8 ID,bool Enable);//是否开启过载保护
	virtual int protectedForce(u8 ID,u8 force);//过载扭矩
private:
