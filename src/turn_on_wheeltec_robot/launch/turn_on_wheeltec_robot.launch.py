...
def generate_launch_description():
    ...
    motor_param_file = '/home/wheeltec/wheeltec_ros2/src/FT/ft_driver/config/params.yaml'

    # 获取ultralytics_ros2包的共享目录
    try:
        yolo_dir = get_package_share_directory('ultralytics_ros2')
        yolo_launch_file = os.path.join(yolo_dir, 'launch', 'yolo.launch.py')
    except:
        yolo_launch_file = None
        print("Warning: ultralytics_ros2 package not found, YOLO launch will be skipped")
