...
public:
    ...
    static const int MSP_ERROR_AIUI_NO_ENOUGH_CAPACITY        = 11216;    /* AIUI装机量授权不足 */
    static const int MSP_ERROR_AIUI_NO_ENOUGH_LICENSE         = 11217;    /* 启动时则为uid变更，交互时则为授权不足 */
    static const int MSP_ERROR_AIUI_SN_ERROR                  = 11218;    /* SN错误，包含非法字符或长度过长，需32位以内 */
